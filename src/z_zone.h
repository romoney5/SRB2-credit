...
enum
{
	...
	PU_PERFSTATS, // static between changes to ps_samplesize cvar
	...
	PU_HWRLIGHTTABLEDATA, // Hardware light table data
...
#define Z_TotalUsage() Z_TagsUsage(0, NUM_PURGETAGS-1)
