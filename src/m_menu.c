...
static menuitem_t OP_VideoOptionsMenu[] =
{
	...
	{IT_STRING | IT_CVAR, NULL, "Message Fadeout Time",              &cv_chattime,    177},
	{IT_STRING | IT_CVAR, NULL, "Chat Notifications",           	 &cv_chatnotifications,  182},
	{IT_STRING | IT_CVAR, NULL, "Spam Protection",           		 &cv_chatspamprotection,  187},
	{IT_STRING | IT_CVAR, NULL, "Chat background tint",           	 &cv_chatbacktint,  192},

	{IT_HEADER, NULL, "Level", NULL, 201},
	{IT_STRING | IT_CVAR, NULL, "Draw Distance",             &cv_drawdist,        207},
	{IT_STRING | IT_CVAR, NULL, "Weather Draw Dist.",        &cv_drawdist_precip, 212},
	{IT_STRING | IT_CVAR, NULL, "NiGHTS Hoop Draw Dist.",    &cv_drawdist_nights, 217},
	{IT_STRING | IT_CVAR, NULL, "Pitch/Roll Rotation",    	 &cv_pitchroll_rotation, 222},
	{IT_STRING | IT_CVAR, NULL, "Ring Racers Screen Quakes", &cv_ringracers_quakes, 227},
    {IT_STRING | IT_CVAR, NULL, "Screenshake Effects", &cv_earthquake, 232},

	{IT_HEADER, NULL, "Diagnostic", NULL, 241},
	{IT_STRING | IT_CVAR, NULL, "Show FPS",                  &cv_ticrate,         247},
	{IT_STRING | IT_CVAR, NULL, "Clear Before Redraw",       &cv_homremoval,      252},
	{IT_STRING | IT_CVAR, NULL, "Show \"FOCUS LOST\"",       &cv_showfocuslost,   257},
	{IT_STRING | IT_CVAR, NULL, "Show Movie Info",           &cv_moviemodeinfo,   262},

#ifdef HWRENDER
	{IT_HEADER, NULL, "Renderer", NULL, 271},
	{IT_CALL | IT_STRING, NULL, "OpenGL Options...",         M_OpenGLOptionsMenu, 277},
	{IT_STRING | IT_CVAR, NULL, "FPS Cap",                   &cv_fpscap,          282},
#endif
};
