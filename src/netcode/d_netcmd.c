...
void D_RegisterServerCommands(void)
{
	...
	COM_AddCommand("delfile", Command_Delfile, COM_LUA|COM_CLIENT); // romoney5: technically it's not in base srb2
	...
	COM_AddCommand("unloadaddons", Command_Unloadaddons, COM_CLIENT);
